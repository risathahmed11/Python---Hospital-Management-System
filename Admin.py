    ...
    def doctor_management(self, doctors):
        ...
        # Update
            ...
            if op == 1:
                ...
                doctors[index].set_first_name(name)
            elif op == 2:
                name=input("enter the name")
                doctors[index].set_surname(name)
            elif op == 3:
                name=input("enter the name")
                doctors[index].set_speciality(name)
        ...
        # Delete
            ...
            if doctor_index <= len(doctors) - 1:
                doctors.remove(doctors[doctor_index])
                              

           
            print('The doctor is deleted')
    ...
    def assign_doctor_to_patient(self, patients, doctors):
        ...
        try:
            ...
            if self.find_index(doctor_index,doctors)!=False:
                ...
                patients[patient_index].link(doctors[doctor_index].get_first_name())
    ...
    def discharge(self, patients, discharge_patients):
        ...
        try:
            ...
            if self.find_index(patient_index,patients)!=False:
                a=patients.pop(patient_index)
                discharge_patients.append(a)
